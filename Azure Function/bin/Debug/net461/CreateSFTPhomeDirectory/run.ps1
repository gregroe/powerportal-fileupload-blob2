...
# Write-Host "PowerShell HTTP trigger function processed a request to create a new container."

# Interact with query parameters or the body of the request.
$containername = $Request.Query.ContainerName

$storageAcc = Get-AzStorageAccount -ResourceGroupName "FTP" -Name "sftpnewgreg"
